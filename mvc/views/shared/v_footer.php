        ...
        <footer>
            ...
            <div class="copyright pt-3 pb-3">
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            <p class="text-white">Copyright &copy; 2019 XinChaoCoder</p>
                        </div>
                        <div class="col-md-6">
                            <ul class="list-payment-sprite text-right">
                                <li><span class="method-1"></span></li>
                                <li><span class="method-2"></span></li>
                                <li><span class="method-3"></span></li>
                            </ul>
                        </div>
                    </div>
                </div>
